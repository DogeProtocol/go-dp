...
func (z *Int) BytesAddress() [32]byte {
	return z.Bytes32()
}
...
// Bytes28 returns the value of z as a 28-byte big-endian array.
func (z *Int) Bytes28() [28]byte {
	var b [28]byte
	// The PutUint*()s are inlined and we get 3x (load, bswap, store) instructions.
	binary.BigEndian.PutUint32(b[0:4], uint32(z[3]))
	binary.BigEndian.PutUint64(b[4:12], z[2])
	binary.BigEndian.PutUint64(b[12:20], z[1])
	binary.BigEndian.PutUint64(b[20:28], z[0])
	return b
}
