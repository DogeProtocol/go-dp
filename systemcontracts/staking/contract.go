...
// 2) abigen --bin=c:\github\go-dp\systemcontracts\staking\stakingv2\StakingContract.bin --abi=c:\github\go-dp\systemcontracts\staking\stakingv2\StakingContract.abi --pkg=stakingv2 --out=c:\github\go-dp\systemcontracts\staking\stakingv2\staking.go
