...
// 3) copy ConversionContract.abi into conversionabi.go
// 4) copy ConversionContract-runtime.bin into conversionbin.go CONVERSION_RUNTIME_BIN field
...
func GetConversionContract_ABI() (abi.ABI, error) {
	a, err := abi.JSON(strings.NewReader(CONVERSION_ABI))
	return a, err
}
