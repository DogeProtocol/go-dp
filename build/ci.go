...
import (
	...
	"github.com/DogeProtocol/dp/crypto/signify"
	"github.com/DogeProtocol/dp/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/DogeProtocol/dp/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/DogeProtocol/dp/mobile")
