...
func (w *wizard) deployExplorer() {
	...
	if out, err := deployExplorer(client, w.network, w.conf.bootnodes, infos, nocache, w.conf.Genesis.Config.Clique != nil, w.conf.Genesis.Config.ProofOfStake != nil); err != nil {
